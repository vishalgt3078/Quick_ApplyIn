...
def get_chromedriver(data):
  """
  Function to initialize and return the ChromeDriver instance.
  """
  options = webdriver.ChromeOptions()
  # Add any desired options here (e.g., options.add_argument("--headless"))
...
class EasyApplyLinkedin:
    ...
    def __init__(self, data):
        ...
        self.driver = get_chromedriver(data)  # Use the get_chromedriver function
    ...
    def find_offers(self):
        ...
        total_results = self.driver.find_element(By.CSS_SELECTOR, ".display-flex.t-12.t-black--light.t-normal")
...
if __name__ == '__main__':
    ...
    bot.apply()  # Assuming you have a method called apply()
    bot.login_linkedin()
